import { Features, FeaturesProps, Highlighter } from '@ayahub/ui';
...
const example = `import { ThemeProvider, GradientButton } from '@ayahub/ui'
    ...
    <Center gap={16}>
      <Center>
        ...
        <div style={{ color: theme.colorTextDescription, textAlign: 'center' }}>
          The AyaUI components are developed based on{' '}
